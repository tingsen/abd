...
return  array(
    ...
    'MODULE_ALLOW_LIST'     => array('Home','Admin','Api','Wap'), //分组
    ...
    'COOKIE_PREFIX'         => 'jz_', // Cookie前缀 避免冲突

    /* SESSION设置 */
    'SESSION_AUTO_START'    => true, // 是否自动开启Session
    'SESSION_OPTIONS'       => array(), // session 配置数组 支持type name id path expire domain 等参数
    'SESSION_TYPE'          => '', // session hander类型 默认无需设置 除非扩展了session hander驱动
    'SESSION_PREFIX'        => 'jz_', // session 前缀

    /* 数据库设置 */
    'DB_TYPE'               => 'mysql', // 数据库类型
    'DB_HOST'               => '172.17.0.15', // 服务器地址
    ...
    'TMPL_PARSE_STRING'     => array(
        ...
        '__WEBHOME__'     => __ROOT__.'/Public/Home',
    ),

    /* URL设置 */
    'URL_CASE_INSENSITIVE'  => false, // 默认false 表示URL区分大小写 true则表示不区分大小写
    'URL_MODEL'             => 1, // 0 (普通模式); 1 (PATHINFO 模式); 2 (REWRITE  模式); 3 (兼容模式)  默认为PATHINFO 模式，提供最好的用户体验和SEO支持
    ...
    //扩展配置
    'LOAD_EXT_CONFIG'       => 'regular,other,alipay,socialize',
    'LOAD_EXT_FILE'         => 'Upload',
    //api路径
    'API_URL'               => 'http://jizhang.cftech.top',
    //缩略图前缀
    'THUMB_PREFIX'          => 'thumb_',
